...
public class DeleteUserTest extends BaseTest {
	...
	public void deleteUserTest_TC1() {
			...
			Response deleteRes = rc.deleteAPICAll(BASE_URL_GOREST, "/public/v2/users/"+userId, null, null, AuthType.BEARER_TOKEN, ContentType.JSON);
			Assert.assertEquals(deleteRes.statusCode(), 204);
			
			//4.GET: recheck the deleted user's data using his id
			Response getResAfterDelete = rc.getAPICall(BASE_URL_GOREST, "/public/v2/users/"+userId, null, null, AuthType.BEARER_TOKEN, ContentType.JSON);
